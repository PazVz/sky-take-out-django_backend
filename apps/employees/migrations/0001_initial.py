    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_number', models.CharField(max_length=18, verbose_name='ID Number')),
                ('status', models.IntegerField(choices=[(1, 'normal'), (0, 'locked')], default=1, verbose_name='Account Status')),
